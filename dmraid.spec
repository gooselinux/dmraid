...
Patch3: spare_led_is_still_in_rebuilding_state.patch
Patch4: move_pattern_file_to_var.patch
Patch5: version.1.0.0.rc16-5.patch
Patch6: fix_sil_jbod.patch
Patch7: avoid_register.patch
...
# Create version symlinks to libdmraid*.so.1 we link against
...
* Wed Jul 14 2010  Zdenek Kabelac <zkabelac@redhat.com> - 1.0.0.rc16-9
- Adds pthread library for linking dmeventd plugin
- Resolves: rhbz#582987

* Mon Mar 01 2010  Heinz Mauelshagen <heinzm@redhat.com> - 1.0.0.rc16-8
- Return an error when no disks are discovered
- Resolves: rhbz#568868

* Tue Jan 21 2010  Heinz Mauelshagen <heinzm@redhat.com> - 1.0.0.rc16-7
- Create symlink from full versioned libdmraid dso files
  to libdmraid.so.1 and libdmraid-events-isw.so.1
  (ie. soname we use for linking)
- Resolves: rhbz#557514

* Tue Jan 19 2010  Heinz Mauelshagen <heinzm@redhat.com> - 1.0.0.rc16-6
- change libdmraid version to 1
- Resolves: rhbz#556860

* Tue Jan 12 2010  Heinz Mauelshagen <heinzm@redhat.com> - 1.0.0.rc16-5
- Resolves: rhbz#554698
  SGPIO spare led is still in rebuilding state fix
- Resolves rhbz#554700
  switch to using /var/cache/logwatch/dmeventd/syslogpattern.txt;
  explicitly claim logwatch files in dmraid-events-logwatch
- Resolves rhbz#554708
  gets size of Silicon Image JBOD set wrong fix
- Resolves rhbz#554710
  try to register non-existent dmeventd DSO fix

* Fri Oct 16 2009  Heinz Mauelshagen <heinzm@redhat.com> - 1.0.0.rc16-4
